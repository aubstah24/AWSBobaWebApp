    ...
    return (
        <Container className='menupage'>
            ...
            <div className="bio">
                ...
                <br/>
                <p style={{fontFamily: 'Metro Nova Hawaiian Regular', fontSize: '14px', paddingLeft: "15px", paddingRight: "15px"}}>We are a family-owned business and we work hard to create a comfortable experience. Our boba shop is
            ...
            <Header as='h1' textAlign="center">Our Kope</Header>
            <p style={{fontFamily: 'Metro Nova Hawaiian Regular', fontSize: '16px', textAlign: "center"}} >
            ...
            <Grid columns='equal' style={{padding: '40px'}}>
                <GridRow>
                    <GridColumn textAlign='center' width={5}>
                        <Segment>Kaʻu Coffee Mill’s coffees are produced with 100% renewable energy from our
                            Hydroelectric
                ...
                <GridRow>
                    ...
                    <GridColumn textAlign='center' width={4}>
                        <Segment>With exceptional quality potential at high altitudes, SL34 is known for flavors
                            characterized by a complex citric acidity, heavy mouthfeel and a clean, sweet finish.
                ...
                <GridRow columns={3}>
                    <GridColumn textAlign='center' width={5}>
                        <Segment>Award-winning coffee is grown in the heart of the Big Island and is handpicked at peak
                            ripeness for rich flavor.
                ...
                <GridRow columns={3}>
                    ...
                    <GridColumn textAlign='center' width={4}>
                        <Segment>
                            We’re Holualoa Kona Coffee Company, and we’re proud to be innovators of the highest
                            standard. Our coffee and facility is certified Organic by Where Food Comes From.
                            Through meticulous and reliable work, our company has become known as one of the top Organic
                            Coffee Processors in Kona, Hawaii.
                        </Segment>
                    </GridColumn>
                </GridRow>
