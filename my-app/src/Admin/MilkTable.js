...
export function MilkTable () {
    ...
    async function getData() {
        const { data } = await supabase.from("MilkOptions").select().order('key', {ascending: true});
        setMilks(data);
    }
    ...
    return (
        <div>
            <Header as="h1" textAlign="center">Current Milk Options</Header>
            <Table celled padded>
                <TableHeader>
            ...
            <Container>
                <Form>
                    ...
                    />
                    <br/>
                    <Button type='submit' onClick={addItem} primary>ADD MILK OPTION</Button>
                </Form>
            </Container>
            ...
            <Container>
                ...
                <br/><br/>
                <Input type='text' label='New Name:' onChange={(e) => setMilkEdit(e.target.value)}/>
                <br/><br/>
